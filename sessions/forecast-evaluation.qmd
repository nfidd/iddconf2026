...
In this session we will use the `nfidd` package to load a data set of infection times and forecasts, the `dplyr` package for data wrangling, the `ggplot2` library for plotting and the `scoringutils` package for evaluating forecasts.
